  ...
  return (
    <div className={"infoBody"}>
        ...
        <ul>
            ...
            <li>Components with the keyword <span className='code'>@PLUGIN_SKIP</span> in their description are automatically skipped. This keyword is added to the following files:
            <ul>
              <li>Company Logos</li>
              <li>Team Logos</li>
              <li>Country Flags</li>
